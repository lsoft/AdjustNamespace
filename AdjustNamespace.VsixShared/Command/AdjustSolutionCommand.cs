...
{
    /// <summary>
    /// Handler of the `Extensions -> Adjust Namespace -> Adjust namespaces in solution...` command.
    /// Takes every physical file of the opened solution and opens the wizard
    ...
    internal sealed class AdjustSolutionCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdjustSolutionCommand"/> class.
