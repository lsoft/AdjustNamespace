...
namespace AdjustNamespace.Tests.Roslyn
{
    /// <summary>
    /// Tests of <see cref="SyntaxExtensions"/>: the helpers the reference processing is built of.
    /// </summary>
    public class SyntaxExtensionsTests
    {
        ...
        /// <summary>
        /// <see cref="SyntaxExtensions.ToUpperSyntax{T}"/> returns the outermost node of the
        ...
        /// <summary>
        /// <see cref="SyntaxExtensions.GoDownTo"/> searches for the exact type of a node.
        /// </summary>
        [Fact]
...
");
        ...
        /// see <see cref="SyntaxExtensions.GetIndentationOf"/>.
        /// </summary>
        [Fact]
...
");
        ...
        /// see <see cref="SyntaxExtensions.AddUsingKeepingHeader"/>.
        /// </summary>
        [Fact]
